...
<h1 class="text-center">CHỌN HÌNH THỨC THANH TOÁN</h1>

<p class="lead text-center">

<a href="order.php?c_id=<?php echo $customer_id; ?>">Thanh toán trực tiếp</a>
...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
  ...
  alt="PayPal - Cách thanh toán trực tuyến an toàn hơn, dễ dàng hơn!">
