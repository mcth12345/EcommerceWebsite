...
<i class="fa fa-dashboard"></i> Bảng điều khiển / Chỉnh sửa thông tin nhà sản xuất
...
<i class="fa fa-money fa-fw"> </i> Chỉnh sửa thông tin nhà sản xuất
...
echo "<script>alert('Nhà sản xuất đã được cập nhật thành công')</script>";
