...
<i class="fa fa-dashboard"> </i> Bảng điều khiển / Chỉnh sửa phiếu giảm giá
...
<label class="col-md-3 control-label"> Giá phiêu giảm giá </label>
...
<label class="col-md-3 control-label"> Giới hạng số lượng phiếu </label>
...
<label class="col-md-3 control-label"> Phiếu giảm giá cho sản phẩm hoặc gói </label>
...
<option>Phần phiếu giảm giá gói</option>
...
<input type="submit" name="update" class=" btn btn-primary form-control" value=" Cập nhật">
...
echo "<script>alert('Phiếu giảm giá đã được cập nhật thành công')</script>";
