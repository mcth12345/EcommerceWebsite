...
<label class="col-md-3 control-label" > Địa chỉ tài nguyên sản phẩm </label>
...
<div class="form-group" ><!-- form-group Starts -->
  ...
  <label class="col-md-3 control-label" > Số lượng kích cỡ sản phẩm nhỏ </label>

  <div class="col-md-6" >

    <input type="number" name="p_s_Small" value="1" class="form-control" required >
...
<div class="form-group" ><!-- form-group Starts -->
  ...
  <label class="col-md-3 control-label" > Số lượng kích cỡ sản phẩm vừa</label>

  <div class="col-md-6" >

    <input type="number" name="p_s_Medium" value="1" class="form-control" required >
...
<div class="form-group" ><!-- form-group Starts -->
  ...
  <label class="col-md-3 control-label" > Số lượng kích cỡ sản phẩm lớn </label>

  <div class="col-md-6" >

    <input type="number" name="p_s_Large" value="1" class="form-control" required >
...
<label class="col-md-3 control-label" > Giá bán giảm giá </label>
...
<label class="col-md-3 control-label" > Thông tin về sản phẩm </label>
...
<a data-toggle="tab" href="#description"> Mô tả chi tiết </a>
...
$product_size_small = $_POST['p_s_Small'];
$product_size_Medium = $_POST['p_s_Medium'];
$product_size_Large = $_POST['p_s_Large'];
...
$get_p_id_new="SELECT product_id FROM products ORDER BY product_id DESC LIMIT 1";

$run_products = mysqli_query($con,$get_p_id_new); // thuc thi

$row_products = mysqli_fetch_array($run_products); // lay row dau

$product_title = $row_products['product_id']; // lay dlieu

$insert_product_size1 = "insert into product_size (product_id, MaSize, qyt) values ($product_title,1,$product_size_small)";
$insert_product_size2 = "insert into product_size (product_id, MaSize, qyt) values ($product_title,2,$product_size_Medium)";
$insert_product_size3 = "insert into product_size (product_id, MaSize, qyt) values ($product_title,3,$product_size_Large)";

$run_product_size1 = mysqli_query($con,$insert_product_size1);
$run_product_size2 = mysqli_query($con,$insert_product_size2);
$run_product_size3 = mysqli_query($con,$insert_product_size3);
