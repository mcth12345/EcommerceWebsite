...
<i class="fa fa-dashboard" ></i> Bảng điều khiển / Chỉnh sửa thông tin liên hệ
...
<i class="fa fa-money fa-fw"></i> Chỉnh sửa thông tin liên hệ
...
<label class="col-md-3 control-label"> Địa chỉ Email liên hệ </label>
...
<label class="col-md-3 control-label"> Tiêu đề liên hệ </label>
...
<label class="col-md-3 control-label"> Mô tả liên hệ </label>
...
echo "<script>alert('Liên hệ với chúng tôi đã được cập nhật thành công')</script>";
