...
<i class="fa fa-dashboard" ></i> Bảng điều khiển / Chỉnh sửa thông tin về chúng tôi
...
<i class="fa fa-money fa-fw"></i> Chỉnh sửa thông tin về chúng tôi
...
<label class="col-md-3 control-label"> Tiêu đề giới thiệu  </label>
...
<label class="col-md-3 control-label"> Mô tả ngắn gọn </label>
...
echo "<script>alert('Những thông tin về trang đã được cập nhật thành công')</script>";
