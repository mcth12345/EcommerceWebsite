...
<i class="fa fa-dashboard"></i> Bảng điều khiển / Chỉnh sửa mối quan hệ sản phẩm nhóm
...
<i  class="fa fa-money fa-fw"></i> Chỉnh sửa mối quan hệ sản phẩm nhóm
...
<label class="col-md-3 control-label"> Tiêu đề mối quan hệ sản phẩm nhóm </label>
...
<label class="col-md-3 control-label"> Gói sản phẩm  </label>
...
echo "<script>alert('Mối quan hệ mới đã được cập nhật thành công')</script>";
