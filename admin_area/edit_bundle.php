...
<title> Chỉnh sửa gói sản phẩm </title>
...
<i class="fa fa-dashboard"> </i> Bảng điều khiển / Chỉnh sửa gói sản phẩm
...
<i class="fa fa-money fa-fw"></i> Chỉnh sửa gói sản phẩm
...
<label class="col-md-3 control-label" > Tiêu đề gói sản phẩm </label>
...
<label class="col-md-3 control-label" > Địa chỉ tài nguyên gói </label>
...
<label class="col-md-3 control-label" > Nhà sẳn xuất </label>
...
<label class="col-md-3 control-label" > Ảnh gói 1 </label>
...
<label class="col-md-3 control-label" > Ảnh gói 2 </label>
...
<label class="col-md-3 control-label" > Ảnh gói 3 </label>
...
<label class="col-md-3 control-label" > Thông tin về gói sản phẩm </label>
...
<label class="col-md-3 control-label" > Nhãn gói sản phẩm </label>
...
echo "<script> alert('Gói sản phẩm đã được sửa thêm thành công') </script>";
