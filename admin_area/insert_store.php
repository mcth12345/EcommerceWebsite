...
<i class="fa fa-dashboard" ></i> Bảng điều khiển / Thêm thông tin cửa hàng
...
<i class="fa fa-money fa-fw"></i> Thêm thông tin cửa hàng
...
echo "<script>alert('Cửa hàng đã được thêm thành công')</script>";
