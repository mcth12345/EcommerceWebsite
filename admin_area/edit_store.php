...
<i class="fa fa-dashboard" ></i> Bảng điều khiển / Chỉnh sửa thông tin cửa hàng
...
<i class="fa fa-money fa-fw"></i> Chỉnh sửa thông tin cửa hàng
...
<label class="col-md-3 control-label"> Ảnh cửa hàng </label>
...
<label class="col-md-3 control-label"> Địa chỉ tài nguyên cửa hàng (URL) </label>
...
echo "<script>alert('Cửa hàng đã được cập nhật thành công')</script>";
