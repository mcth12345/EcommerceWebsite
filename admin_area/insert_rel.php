...
<i class="fa fa-dashboard"></i> Bảng điều khiển / Thêm mối quan hệ sản phẩm nhóm
...
<i  class="fa fa-money fa-fw"></i> Thêm mối quan hệ sản phẩm nhóm
...
<option> Chọn gói sản phẩm </option>
...
echo "<script>alert('Mối quan hệ mới đã được thêm thành công')</script>";
