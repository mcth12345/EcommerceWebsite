...
<i class="fa fa-dashboard"> </i> Bảng điều khiển / thêm gói
...
<label class="col-md-3 control-label" > Tiêu đề cho gói </label>
...
<label class="col-md-3 control-label" > Địa chỉ cấp tài nguyên gói </label>
...
<label class="col-md-3 control-label" > Giá gói giảm giá </label>
...
<label class="col-md-3 control-label" > Từ khóa gói </label>
...
<label class="col-md-3 control-label" > Thông tin về gói </label>
...
<input type="submit" name="submit" value="Thêm gói" class="btn btn-primary form-control" >
...
echo "<script>alert('Gói sản phẩm đã được thêm thành công')</script>";
