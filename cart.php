  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">GIỎ </span> HÀNG CỦA TÔI
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<p class="text-muted" > Hiện có <?php echo $count; ?> mặt hàng trong giỏ hàng của bạn. </p>
...
<td>
<!-- hienn tien dơn giá / có $-->
<?php echo $only_price; ?>.000 VNĐ
...
<th colspan="2"> <?php echo $total; ?>.000 VNĐ</th>
<!-- số tiền
    <th colspan="2"> $<?php echo $total; ?>.00 VNĐ</th> -->
...
<input class="btn btn-primary" type="submit" name="apply_coupon" value="Áp dụng mã giảm giá" >
...
<div class="box-footer"><!-- box-footer Starts -->
  ...
  <div class="pull-right"><!-- pull-right Starts -->
    ...
    <button class="btn btn-info" type="submit" name="update" value="Cập nhật giỏ hàng">
...
echo "<script>alert('
Mã giảm giá của bạn đã hết hạn')</script>";
...
if($check_cart == 1){
  ...
  echo "<script>alert('Mã giảm giá của bạn đã được áp dụng')</script>";
...
echo "<script> alert('Mã giảm giá của bạn không hợp lệ') </script>";
...
?>
<center><h3>NHỮNG SẢN PHẨM BẠN CÓ THỂ THÍCH</h3></center>
...
$product_price = "<del> $pro_price.000 </del>";

$product_psp_price = "| $pro_psp_price.000 VNĐ";
...
$product_price = "$pro_price.000 VNĐ";
...
<div class="col-md-4"><!-- col-md-3 Starts -->
  ...
  <div class="box" id="order-summary"><!-- box Starts -->
    ...
    Chi phí vận chuyển và chi phí bổ sung được tính dựa trên các giá trị bạn đã nhập. -->
    Tổng chi phí hóa đơn dựa trên chi phí vận chuyển và giá trị ứng với từng sản phẩm bạn đã chọn.
    </p>
