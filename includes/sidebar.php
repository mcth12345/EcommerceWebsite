    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data starts -->
        ...
        <div class="panel-body"><!-- panel-body Starts -->
            ...
            <form name="form" action="" method="get">
                <input type="text" name="query" id="subject" placeholder="Tìm kiếm" />
                <input type ="submit" class="fa fa-search" value="Tìm kiếm"/>
            </form>
...
<input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-manufacturer" placeholder="Chọn nhà sản xuất">
...
<input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-p-cats" placeholder="Chọn danh mục sản phẩm">
...
<input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-cats" placeholder="Chọn danh mục">
