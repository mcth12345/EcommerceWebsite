      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="index.php">
            <img class="logo__img" src="./images/alogoweb2.jpg"  width="237" height="19">
          </a>
        </div>
        ...
        <nav class="main-nav">
          <ul class="categories">
            ...
            <li class="categories__item">
              <a class="categories__link" href="shop.php?page=1&cat[]=5&">
                NAM
            ...
            <li class="categories__item">
              <a class="categories__link" href="shop.php?page=1&cat[]=2&">
                NỮ
