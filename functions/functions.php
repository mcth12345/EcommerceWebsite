...
$product_price = "<del> $pro_price.000 </del>"; /*biểu ddien giảm gí*/ 

$product_psp_price = "| $pro_psp_price.000 VNĐ"; /*biểu ddien giảm gí*/ 
...
$product_price = "$pro_price.000 VNĐ"; /*biểu dien giá */
...
/// getPaginator Function Ends ///
  ...
  function fgetProducts($query){
    ...
    while($row_products=mysqli_fetch_array($run_products)){
        ...
        $product_price = "<del> $pro_price.000 VNĐ </del>";
